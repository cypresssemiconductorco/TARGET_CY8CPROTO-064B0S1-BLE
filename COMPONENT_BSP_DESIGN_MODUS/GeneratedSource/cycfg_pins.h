...
#endif //defined (CY_USING_HAL)
#define CYBSP_SWDCLK_ENABLED 1U
#define CYBSP_SWDCK_ENABLED CYBSP_SWDCLK_ENABLED
#define CYBSP_SWDCLK_PORT GPIO_PRT6
#define CYBSP_SWDCK_PORT CYBSP_SWDCLK_PORT
#define CYBSP_SWDCLK_PORT_NUM 6U
#define CYBSP_SWDCK_PORT_NUM CYBSP_SWDCLK_PORT_NUM
#define CYBSP_SWDCLK_PIN 7U
#define CYBSP_SWDCK_PIN CYBSP_SWDCLK_PIN
#define CYBSP_SWDCLK_NUM 7U
#define CYBSP_SWDCK_NUM CYBSP_SWDCLK_NUM
#define CYBSP_SWDCLK_DRIVEMODE CY_GPIO_DM_PULLDOWN
#define CYBSP_SWDCK_DRIVEMODE CYBSP_SWDCLK_DRIVEMODE
#define CYBSP_SWDCLK_INIT_DRIVESTATE 1
#define CYBSP_SWDCK_INIT_DRIVESTATE CYBSP_SWDCLK_INIT_DRIVESTATE
#ifndef ioss_0_port_6_pin_7_HSIOM
	#define ioss_0_port_6_pin_7_HSIOM HSIOM_SEL_GPIO
#endif
#define CYBSP_SWDCLK_HSIOM ioss_0_port_6_pin_7_HSIOM
#define CYBSP_SWDCK_HSIOM CYBSP_SWDCLK_HSIOM
#define CYBSP_SWDCLK_IRQ ioss_interrupts_gpio_6_IRQn
#define CYBSP_SWDCK_IRQ CYBSP_SWDCLK_IRQ
#if defined (CY_USING_HAL)
	#define CYBSP_SWDCLK_HAL_PORT_PIN P6_7
	#define CYBSP_SWDCK_HAL_PORT_PIN CYBSP_SWDCLK_HAL_PORT_PIN
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
	#define CYBSP_SWDCLK P6_7
	#define CYBSP_SWDCK CYBSP_SWDCLK
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
	#define CYBSP_SWDCLK_HAL_IRQ CYHAL_GPIO_IRQ_NONE
	#define CYBSP_SWDCK_HAL_IRQ CYBSP_SWDCLK_HAL_IRQ
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
	#define CYBSP_SWDCLK_HAL_DIR CYHAL_GPIO_DIR_BIDIRECTIONAL 
	#define CYBSP_SWDCK_HAL_DIR CYBSP_SWDCLK_HAL_DIR
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
	#define CYBSP_SWDCLK_HAL_DRIVEMODE CYHAL_GPIO_DRIVE_PULLDOWN
	#define CYBSP_SWDCK_HAL_DRIVEMODE CYBSP_SWDCLK_HAL_DRIVEMODE
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
...
#endif //defined (CY_USING_HAL)
extern const cy_stc_gpio_pin_config_t CYBSP_SWDCLK_config;
#define CYBSP_SWDCK_config CYBSP_SWDCLK_config
#if defined (CY_USING_HAL)
	extern const cyhal_resource_inst_t CYBSP_SWDCLK_obj;
	#define CYBSP_SWDCK_obj CYBSP_SWDCLK_obj
#endif //defined (CY_USING_HAL)
